...
# syncnet_lstm.fit(x=train_inputs, y=train_outputs, batch_size=100, epochs=100, verbose=1, callbacks=[lr_reducer, checkpointAndMakePlots], validation_data=[val_inputs, val_outpus], shuffle=True, class_weight=class_weight)

# LRW_train_syncnet_lstm_preds = syncnet_lstm
