...
def my_assessor_model(use_CNN_LSTM=True, use_head_pose=True, mouth_nn='cnn', trainable_syncnet=False,
                      ...
                      residual_part=False, res_fc_1=2, res_dropout_p1=0.5, res_fc_2=2, res_dropout_p2=0.5):
    ...
    if last_fc is None:
        ...
        if residual_part:
            ...
            res_bn1 = BatchNormalization(name='res_bn1')(res_ac1)
            res_dp1 = Dropout(res_dropout_p1, name='res_dropout1_p'+str(res_dropout_p1))(res_bn1)
            res_fc1 = Dense(res_fc_2, kernel_regularizer=l2(1.e-4), name='res_fc2')(res_dp1)
            res_ac2 = Activation('relu', name='res_relu_fc2')(res_fc1)
            res_bn2 = BatchNormalization(name='res_bn2')(res_ac2)
            res_dp2 = Dropout(res_dropout_p2, name='res_dropout2_p'+str(res_dropout_p2))(res_bn2)
            clf_input = Add()([dp2, res_dp2])
        else:
            clf_input = dp2
