...
assessor = my_assessor_model(use_CNN_LSTM=use_CNN_LSTM, use_head_pose=use_head_pose, mouth_nn=mouth_nn, trainable_syncnet=trainable_syncnet,
                             ...
                             residual_part=True, res_fc_1=res_fc_1, res_dropout_p1=res_dropout_p1, res_fc_2=res_fc_2, res_dropout_p2=res_dropout_p2)
...
lr_reducer = ReduceLROnPlateau(factor=np.sqrt(0.1), patience=5, min_lr=5e-7)
